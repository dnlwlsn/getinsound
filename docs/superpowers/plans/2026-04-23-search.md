...
```
NEW FILES:
  supabase/migrations/0020_search.sql         — tsvector columns, GIN indexes, RPCs, trigram, search_logs
...
**Files:**
- Create: `supabase/migrations/0020_search.sql`
...
```bash
git add supabase/migrations/0020_search.sql
