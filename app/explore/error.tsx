  ...
  return (
    <div className="min-h-screen bg-insound-bg flex items-center justify-center p-6 font-display">
      <div className="text-center">
        ...
        <h1 className="text-2xl font-black text-zinc-100 mb-3">We couldn&apos;t load Explore right now.</h1>
        <p className="text-sm text-zinc-500 mb-6">Try refreshing, or come back in a moment.</p>
        <button
          onClick={reset}
